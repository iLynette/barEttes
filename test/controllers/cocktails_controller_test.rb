...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference("Cocktail.count") do
      post cocktails_url, params: { cocktail: { alcohol_content: @cocktail.alcohol_content, calories: @cocktail.calories, drink_type: @cocktail.drink_type, ingredients: @cocktail.ingredients } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { alcohol_content: @cocktail.alcohol_content, calories: @cocktail.calories, drink_type: @cocktail.drink_type, ingredients: @cocktail.ingredients } }
